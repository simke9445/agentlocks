...
`win32-arm64` is out of scope until a Bun cross-compile target and a GitHub `windows-11-arm` runner
both exist; until then the launcher falls back to Bun or errors actionably.
