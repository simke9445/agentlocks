...
#
# Byte-identical extraction of the view_integrity() helper inlined three times in release.yml (the
# monotonic-version guard, the platform-publish guard, and the flip). Prints the integrity to stdout
